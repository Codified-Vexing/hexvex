...
# License: GNU GPLv3
# Author: Diogo Duarte
# This program builds the microcode binaries to be recorded in a HexVex decoder 
# ROMS. This enables the binaries produced by the assembler, read from program
# memory, to make sense in the system mechanisms.
